 ...
 * Generated for Laravel 4.1.31 on 2014-10-04.
 *
...
namespace {
    ...
    class Queue extends \Illuminate\Support\Facades\Queue{
         ...
         *
         * @param string $name
         * @return \Pafelin\Gearman\GearmanQueue 
         * @static 
         */
        public static function connection($name = null){
        ...
        public static function push($job, $data = '', $queue = null){
            return \Pafelin\Gearman\GearmanQueue::push($job, $data, $queue);
        }
        ...
        public static function later($delay, $job, $data = '', $queue = null){
            return \Pafelin\Gearman\GearmanQueue::later($delay, $job, $data, $queue);
        }
         ...
         *
         * @param null $queue
         * @return \Illuminate\Queue\Jobs\Job|\Illuminate\Queue\null|\Pafelin\Gearman\GearmanJob 
         * @static 
         */
        public static function pop($queue = null){
            return \Pafelin\Gearman\GearmanQueue::pop($queue);
        }
        ...
        public static function pushRaw($payload, $queue = null, $options = array()){
            return \Pafelin\Gearman\GearmanQueue::pushRaw($payload, $queue, $options);
        }
        ...
        public static function marshal(){
            ...
            return \Pafelin\Gearman\GearmanQueue::marshal();
        }
        ...
        public static function bulk($jobs, $data = '', $queue = null){
            //Method inherited from \Illuminate\Queue\Queue            
            return \Pafelin\Gearman\GearmanQueue::bulk($jobs, $data, $queue);
        }
        ...
        public static function getTime(){
            //Method inherited from \Illuminate\Queue\Queue            
            return \Pafelin\Gearman\GearmanQueue::getTime();
        }
        ...
        public static function setContainer($container){
            //Method inherited from \Illuminate\Queue\Queue            
            \Pafelin\Gearman\GearmanQueue::setContainer($container);
        }
