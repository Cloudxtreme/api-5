...
use League\OAuth2\Server\Util\Request as OAuth2UtilRequest;
//use League\OAuth2\Server\AuthServer as OAuth2AuthServer;
//use League\OAuth2\Server as OAuth2AuthServer;
use League\OAuth2\Server\Authorization as OAuth2AuthServer;
use League\OAuth2\Server\Grant\AuthCode as OAuth2GrantAuthCode;
...
//Route::get('a', function() {
	...
	//$params = $server->checkAuthorizeParams();
